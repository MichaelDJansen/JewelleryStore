...
public class CustomerFactory {
    public static Customer createCustomer(Name name,String companyName, ContactInformation contactInformation,String address, String username, String password){
